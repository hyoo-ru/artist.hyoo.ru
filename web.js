...
(function ($) {
    class $hyoo_artist extends $mol_stack {
        ...
        External() {
            ...
            obj.uri = () => "https://jin-nin-artist.hf.space/";
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $hyoo_artist.prototype, "External", null);
    $.$hyoo_artist = $hyoo_artist;
})($ || ($ = {}));
//hyoo/artist/-view.tree/artist.view.tree.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("hyoo/artist/artist.css", "[hyoo_artist_external] {\n\tjustify-self: stretch;\n}\n");
})($ || ($ = {}));
//hyoo/artist/-css/artist.css.ts

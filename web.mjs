...
;
	($.$hyoo_artist_app) = class $hyoo_artist_app extends ($.$mol_page) {
		title(){
	...
	($mol_mem(($.$hyoo_artist_app.prototype), "query_changed"));
	($mol_mem(($.$hyoo_artist_app.prototype), "imagine"));
	($mol_mem(($.$hyoo_artist_app.prototype), "Query"));
	($mol_mem(($.$hyoo_artist_app.prototype), "Source"));
	($mol_mem(($.$hyoo_artist_app.prototype), "images"));
	($mol_mem_key(($.$hyoo_artist_app.prototype), "Image"));
	($mol_mem(($.$hyoo_artist_app.prototype), "Images"));
    ...
    (function ($$) {
        class $hyoo_artist_app extends $.$hyoo_artist_app {
            ...
            prompts() {
                ...
                return [prefer, forbid].map(tokens => this.$.$hyoo_lingua_translate('en', tokens.join(' ')));
            }
            query_changed(next) {
                if (next === '')
                    this.query('');
        ...
        __decorate([
            $mol_mem
        ], $hyoo_artist_app.prototype, "title", null);
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $hyoo_artist_app.prototype, "prompts", null);
        __decorate([
            $mol_mem
